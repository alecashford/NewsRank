...
describe GetScores::TwitterFetcher do
  ...
  describe '#count' do
    it "returns the correct count from Twitter" do
      twitter = stub_request(:get, "http://cdn.api.twitter.com/1/urls/count.json?url=http://www.brushnewstribune.com/ci_26167090/council-receives-request-revisit-marijuana-moratorium").to_return(status: 200, body: '{"count":18}', headers: {:content_type => 'application/json'})
      client = GetScores::TwitterFetcher.new("http://www.brushnewstribune.com/ci_26167090/council-receives-request-revisit-marijuana-moratorium")
